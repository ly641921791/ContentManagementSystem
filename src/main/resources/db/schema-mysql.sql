...
(
    ...
    password     VARCHAR(512)     NOT NULL COMMIT '密码',
    true_name    VARCHAR (32)     NOT NULL DEFAULT '' COMMIT '真实姓名',
    email        VARCHAR (64)     NOT NULL DEFAULT '' COMMIT '邮箱',
    phone        VARCHAR (32)     NOT NULL DEFAULT '' COMMIT '手机号',
    enabled      TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMIT '是否启用',
    version      INT UNSIGNED     NOT NULL DEFAULT 0,
    is_deleted   TINYINT UNSIGNED NOT NULL DEFAULT 0,
    create_id    BIGINT UNSIGNED  NOT NULL DEFAULT 0,
    create_time  TIMESTAMP        NOT NULL DEFAULT CURRENT_TIMESTAMP,
